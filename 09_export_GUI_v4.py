"""Component 9 - Export GUI v4
v2: Added 08_results_GUI_v4 to 09_export_GUI_v1
v3: Add 07_data_to_txt_v4 to 09_export_GUI_v2
change Export GUI bg colour from pink to orange
add in error label if export file name is not allowed
change results_button in Results class to 'see_ans_btn' to remove confusion
as there is already a results_button in Quiz class.
Wen-Qi Toh
3/06/22"""
...
class Results:
    ...
    def export(self, data):
        get_export = Export(self, data)


class Export:
    def __init__(self, partner, data):
        print("data=", data)   # for testing purposes
        background = "#E58C52"  # orange
        ...
        self.export_text = Label(self.export_frame,
                                 ...
                                 bg="#52A8E5", fg="black", wrap=250)   # bg colour blue
